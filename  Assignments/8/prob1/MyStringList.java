...
public class MyStringList {
	...
	public void set(int index, String s) {
		if (index < 0 || index >= size || s == null) {
			System.out.println("Index or size is invalid");
		}

		if (size < index) {
			System.out.println("Index can not greater than size.");
		}

		strArray[index] = s;
		System.out.println(index + " position is changed to " + s);
	}
...
//
//		System.out.println(l.indexOf("Richard"));
//		System.out.println(l.removeAt(4));
...
//		MyStringList otherStringList = new MyStringList();
//		otherStringList.add("Bob");
//		otherStringList.add("Steve");
//		System.out.println(l.containsAll(otherStringList));
